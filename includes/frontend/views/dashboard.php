...
<details class="ib-panel ib-help">
    ...
    <ul>
        ...
        <li><strong>Turns.</strong> You get <?php echo (int) IB_Settings::get('turns_per_day'); ?> turns per day. Each warp costs <?php echo (int) IB_Settings::get('move_turn_cost'); ?>, docking at a port costs <?php echo (int) IB_Settings::get('dock_turn_cost'); ?>, and each attack costs <?php echo (int) IB_Settings::get('attack_turn_cost'); ?>. Trading while docked is free.</li>
        ...
        <li><strong>Aurelia and the Imperial Drydock.</strong> The Aurelian Armory in Aurelia (sector 1) sells holds, fighters and shields; Aurelia Prime, the Crown World in the same sector, supplies colonists. The Imperial Drydock also sells ships and Worldseeds. The Imperial Gazette gives its location.</li>
